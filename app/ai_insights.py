...
SYSTEM_PROMPT = (
    ...
    "- A shortfall only exists when the projected balance goes negative. A balance drop that remains positive is not a shortfall.\n"
    ...
    " if income before the specific event raises the balance avoiding a negative balance or the overall downward trend, it is not a risk.\n"
